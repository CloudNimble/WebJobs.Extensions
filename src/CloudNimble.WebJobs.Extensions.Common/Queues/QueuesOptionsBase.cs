...
namespace CloudNimble.WebJobs.Extensions.Common.Queues
{
    ...
    /// <summary>
    /// Represents the options for all queues.
    /// </summary>
    public class QueuesOptionsBase : IOptionsFormatter
    {
        ...
        private readonly int _processorCount = 1;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueuesOptionsBase"/> class.
        /// </summary>
        public QueuesOptionsBase()
        {
        ...
        string IOptionsFormatter.Format()
        {
            var options = new
            {
                ...
                MaxDequeueCount,
                VisibilityTimeout,
                MessageEncoding = MessageEncoding.ToString()
            };
        ...
        /// <summary>
        /// Creates a copy of this <see cref="QueuesOptionsBase" /> instance.
        /// </summary>
        /// <returns></returns>
        public QueuesOptionsBase Clone()
        {
            return new QueuesOptionsBase
            {
