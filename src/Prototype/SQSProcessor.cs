...
namespace CloudNimble.WebJobs.Extensions.Amazon.SQS
{
    ...
    internal class SQSProcessor
    {
        ...
        public SQSProcessor(SQSProcessorFactoryContext context)
        {
            if (context == null)
            {
        ...
        public virtual async Task<bool> BeginProcessingMessageAsync(SQSMessage message, CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> to use</param>
        /// <returns></returns>
        public virtual async Task CompleteProcessingMessageAsync(SQSMessage message, FunctionResult result, CancellationToken cancellationToken)
        {
            if (result.Succeeded)
            {
        ...
        private async Task HandlePoisonMessageAsync(SQSMessage message, CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> to use</param>
        /// <returns></returns>
        protected virtual async Task CopyMessageToPoisonQueueAsync(SQSMessage message, SQSQueue poisonQueue, CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> to use</param>
        /// <returns></returns>
        protected virtual async Task ReleaseMessageAsync(SQSMessage message, FunctionResult result, TimeSpan visibilityTimeout, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> to use</param>
        /// <returns></returns>
        protected virtual async Task DeleteMessageAsync(SQSMessage message, CancellationToken cancellationToken)
        {
            try
            {
            ...
            catch (AmazonSQSException exception)
            {
                ...
                if (exception.IsBadRequestPopReceiptMismatch())
                {
                    ...
                    string msg = $"Unable to delete queue message '{message.Id}' because the {nameof(SQSMessage.PopReceipt)} did not match. This could indicate that the function has modified the message and may be expected.";
